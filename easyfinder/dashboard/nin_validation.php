...
$PAGE_TITLE   = 'NIN Validation';
$URL_NAME     = 'NIN Validation';
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <span class="badge badge-danger p-1"> ₦ <?= NIN_VALIDATION_PRICE ?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            if ($ninPersonalizations = $AdminTask->Get_All_NIN_Validations($Auth->email)) {
                ...
                <!-- Modals -->
                <div class="modal fade" id="NVModal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">NIN validation > NIN validation</h5>
                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="basic-form">
                                    <form id="nin-validation-form">
                                        <div class="form-row">
                                        ...
                                        <button type="submit" class="btn btn-success w-100">
                                            ...
                                            Verify <span class="badge badge-danger p-1">₦ <?= NIN_VALIDATION_PRICE ?></span>
                                        </button>
