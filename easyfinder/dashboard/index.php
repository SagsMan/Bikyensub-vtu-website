...
$_pp_c = mysqli_connect('localhost','eduowrav_bikyensub','YOUR_DB_PASSWORD','eduowrav_bikyensub');
...
$_pp = mysqli_fetch_assoc($_pp_q) ?: [];
$pp_has_account = !empty($_pp['acc_no']);
mysqli_close($_pp_c);
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <a class="whats-app fixed" href="https://api.whatsapp.com/send/?phone=2349044038851&amp;text&amp;app_absent=0" target="_blank">
                                        ...
                                        <div class="mt-4" style="text-align: center;">
                                            ...
                                            <?php
                                                if ($pp_has_account) {
                                                    ...
                                                    echo "<p><strong>Bank:</strong> ".htmlspecialchars($_pp['bank_name'])."</p>";
                                                    echo "<p><strong>Account Number:</strong> <b style='font-size:17px;letter-spacing:1px;color:#10d596'>".htmlspecialchars($_pp['acc_no'])."</b></p>";
                                                    echo "<p><strong>Account Name:</strong> ".htmlspecialchars($_pp['acc_name'])."</p>";
                                                    if (!empty($_pp['acc_no2'])) {
                                                        echo "<hr style='margin:6px 0'>";
                                                        echo "<p><strong>Bank:</strong> ".htmlspecialchars($_pp['bank_name2'])."</p>";
                                                        echo "<p><strong>Account Number:</strong> <b style='font-size:17px;letter-spacing:1px;color:#10d596'>".htmlspecialchars($_pp['acc_no2'])."</b></p>";
                                                        echo "<p><strong>Account Name:</strong> ".htmlspecialchars($_pp['acc_name2'])."</p>";
                                                    }
                                                    echo "<small style='color:#10d596'><i class='fa fa-check-circle'></i> Powered by PaymentPoint</small>";
                                                    echo "</div>";
                                                } else {
                                                    echo "<p><a href='javascript:void(0)' data-toggle='modal' data-target='#KYCModal' class='btn btn-sm' style='background:#10d596;color:#fff'>Submit KYC to activate virtual account</a></p>";
                                                }
                                            ?>
                                ...
                                <div class="media ai-icon">
                                    <div class="media-body">
                                        ...
                                        <div class="mt-4" style="text-align: center;">
                                            ...
                                            <p><strong>Account Number: </strong>8130582453</p>
                                            <p><strong>Account Name: </strong>Bikyen Global Nigeria Limited</p>
                                            <p><strong>Bank: </strong>Moniepont MFB</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        ***********************************-->
            ...
            <?php if ((empty($Auth->nin) && empty($Auth->bvn)) || !$pp_has_account):?>
