...
$PAGE_TITLE   = 'Phone Search Validation';
$URL_NAME     = 'Phone Search_validation';
                        ...
                        <div class="card text-white verification-card shadow py-4">
                            <button data-toggle="modal" data-target="#VNSModal">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="text-white">Phone Search Slip</h5>
                                        <p class="fs-14" style="color: #7e7e7e">
                                            You'll be charge <span class="badge badge-warning p-1">
                                                ₦ 0
                                            </span> if No record found.
                                            ...
                                            if ($ninDetails = $AdminTask->Get_All_NIN_Details($Auth->email)) {
                                                ...
                                                foreach ($ninDetails as $ninDetail) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($ninDetail->type == 'Phone Search Slip'): ?>
                                                                <button class="btn btn-info" onclick="printPhoneSearchSlip(<?php echo htmlspecialchars(json_encode($ninDetail)); ?>)">Print</button>
                                                            <?php endif;?>
                                                        </td>
                                                    </tr>
                                            <?php
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Phone Number Search > Phone Search</h5>
                                    ...
                                    <form id="ps-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" placeholder="09100000000"
                                                    id="phone_num" name="phone">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Search Type</label>
                                                <select class="form-control" id="phone_search_type" name="type">
                                                    <option value="basic">Basic Search</option>
                                                    <option value="advance">Advance Search (with Photo)</option>
                                                </select>
                                            </div>
                                        </div>
