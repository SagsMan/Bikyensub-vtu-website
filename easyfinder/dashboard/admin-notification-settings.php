...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['test_email'])) {
    ...
    $from_name = getSetting($conn, 'resend_from_name') ?: 'Bikyensub';
    $test_to   = $Auth->email;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['test_sms'])) {
    ...
    $sender     = getSetting($conn, 'bulksms_sender_id') ?: 'Bikyensub';
    ...
    if (empty($api_token)) {
        ...
        $payload = http_build_query([
            ...
            'from'          => $sender,
            'to'            => $test_phone,
            'body'          => 'Bikyensub Test: SMS notifications are working! Your Bulk SMS Nigeria is connected.',
            'gateway'       => $gateway,
            'append_sender' => '0',
        ]);
              ...
              <div class="card-body">
                ...
                <div class="form-group mb-0">
                  ...
                  <input type="text" name="resend_from_name" class="form-control"
                    placeholder="Bikyensub"
                    value="<?= htmlspecialchars($s['resend_from_name'] ?: 'Bikyensub') ?>">
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="bulksms_sender_id" class="form-control" maxlength="11"
                    placeholder="Bikyensub"
                    value="<?= htmlspecialchars($s['bulksms_sender_id'] ?: 'Bikyensub') ?>">
